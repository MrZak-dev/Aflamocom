...
<?php
 ...
 ?>
	<head>
			<meta charset="UTF-8"/>
			<title>تحميل فلم <?php echo $fetched_data['movie_title'];?> مترجم | AFlamocom</title>
			<meta name="keyword" content="<?php echo $fetched_data['movie_title']; ?>, مترجم ,جودة,تحميل,عالية,اون لاين,اونلاين,فلم,مشاهدة"/>
			<meta name="description" content="تحميل فلم <?php echo $fetched_data['movie_title']; ?> مترجم جودة عالية "/>
...
<?php
						echo '
						<li><a target="_blank" href="'.$fetched_data["movie_download_1"].'" ><i class="fa fa-download fa-2x"></i> Download Link 1</a></li>
						<li><a target="_blank" href="'.$fetched_data["movie_download_2"].'" ><i class="fa fa-download fa-2x"></i> Download Link 2</a></li>
						<li><a target="_blank" href="'.$fetched_data["movie_download_3"].'" ><i class="fa fa-download fa-2x"></i> Download Link 3</a></li>
						';
?>
			          </ul>
			        </div>
